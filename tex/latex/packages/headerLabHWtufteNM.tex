...
footskip=0.3cm,
  ...
  textwidth=180mm, % main text block
  marginparsep=2mm, % gutter between main text block and margin notes
  marginparwidth=20.mm % width of margin notes
}
...
\fancyhf{}
\usepackage{lastpage}
\rhead{\theactivity \hspace{1cm}\thepage /\pageref{LastPage} \hspace{1cm}}
\lfoot{}
...
\lhead{\textbf{\large{\thetitle}}\tabto{13cm}{Name:\underline{\hspace{5cm}}}} %\rule{2in}{.5pt}
